...
-- The mistake: tool 2 retypes CUSTOMER to String(10), which Alteryx truncates silently, but
-- the translation passes the column straight through in the statement that feeds Output tool
-- 8, so CUSTOMER keeps its full width on stream 3_F.
